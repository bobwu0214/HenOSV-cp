...
const Modeling = () => {
  ...
  const sendToFusion360 = () => {
    ...
    // &privateInfo=aa
    const fusionURL = `fusion360://host/?command=open&file=https%3A%2F%2Fgithub.com%2Fbobwu0214%2FHenOSV-cp%2Fblob%2Fmain%2FFusionAddIn%2Ffusion2web%2Ffusion2web%2Fvehicle_Mtest.f3d&privateInfo=${privateInfo}`;
    // 触发 Fusion 360 运行
